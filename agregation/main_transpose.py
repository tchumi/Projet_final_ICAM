...
def load_dataset(file_path, columns, dtypes, sep=","):
    ...
    # Conversion des colonnes int en float pour éviter l'erreur
...
DATASETS = {
    ...
    "ages": {
        ...
        "dtypes": {
            f"pop{year}": float for year in range(2000, 2023)
        },  # Correction : float au lieu de int
    },
}
...
output_path = "../df_final_transposed_socio.csv"
